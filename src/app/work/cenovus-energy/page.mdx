...
export const caseStudy = {
  ...
  description:
    'Scaled predictive maintenance pipeline processing terabytes of sensor data daily for optimized field operations.',
  summary: [
  ...
  logo,
  image: { ...imageHero, alt: 'Cenovus Energy office' },
  date: '2024-01',
