...
function LinkedInIcon(props) {
  return (
    <svg width={26} viewBox="0 0 58 58" aria-hidden="true" {...props}>
...
export const socialMediaProfiles = [
  { title: 'GitHub', href: 'https://github.com/GroupLabs', icon: GitHubIcon },
  { title: 'LinkedIn', href: 'https://www.linkedin.com/company/grouplabs-canada/', icon: LinkedInIcon },
]
